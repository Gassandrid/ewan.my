...
The core idea is a new *emergent* property of obisidian - **attention focus**, you can let your own flow guide you and the correct tasks and writing will get done, much like a [[Hopfield Networks|Hopfield Network]] descending to the lowest energy state. 

- This could be classic [[Garden Tending]] which never finds a time to be done, addressing the enormous backlog I have waiting for me. This could also actually be for addressing [[Tasknotes in my workflow|tasknotes]] work, working through active tasks in a passive way? not sure
