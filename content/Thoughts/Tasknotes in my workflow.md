...
**However**, I dont want tasknote content to be shaped like this, so the only application of tasknote maturation I can think of is for journaling in a append-style form of editing. For notes like [[Hodgkin Huxley Model]] which HAVE an associated tasknote task ( [[abstract modeling notes comp neuro]] ), I dont see it as working well as by "maturing" the task note I have to delete all the thought processing that was recorded in that note. TaskNotes SHOULD have content regarding the process of thinking, but many notes go through "cleaning up" which I dont want for tasknotes. In addition, tasknotes cant really be used as normal notes due to their linking functinoality ( see how the [[Hodgkin Huxley Model|hodkin huxley]] task is rended ), so in actuality it may not be best to "mature" these notes. 
