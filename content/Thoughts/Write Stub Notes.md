...
Central point, defined a little in [[Colophon For Mind Structure]], is that the best way to properly utilize the [[Using an Inbox System|inbox]] system is to write a very short, incomplete note and immediately move it out. Inbox has been working great, but I want to prevent a backlog from happening while also capitlizing on the ideas of "set and forget" note taking.
...
This is also the best way to solve the [[Uncreated Notes|Uncreated Note]] problem: dont leave broken links lying around the place, make them in inbox and write some shitty summary which obviously misses a lot of the content. A note doesnt need to be complete to be out of the inbox.
