...
A lot of tags also have **subtags**. My note - taking app treats tags like folders in that tags can have parents and children ( computer science terminology ). For example, you can have a tag `#pets/cats/Oreo`, where Oreo is a cat, but ALSO a pet
