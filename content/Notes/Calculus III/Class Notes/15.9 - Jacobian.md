...
> $$
> 
> The Jacobian "stretces" the rectangle $\Delta u\Delta v$ to create the area element.
> 3. **If the Jacobian is negative, we take its abosulte value in the integral ( the area element is positive)**
