...
Recently, there have been some significant advancements in decoding the hippocampus, and how it is involved in memory. This is a very complex structure, and it is not yet fully understood. However, we do know that the hipoocampus is involved in the formation of new memories, and the retrieval of old ones.
