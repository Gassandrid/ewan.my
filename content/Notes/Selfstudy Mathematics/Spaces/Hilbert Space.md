...
We could just as easily use any other two [[Notes/Linear Algebra/Module 1/Vectors|vectors]] to form our coordinate system( so long as they have a $90^\circ$ angle between them ):

![[Screenshot 2025-06-13 at 2.34.15 PM.png]]

Within the field of [[Essence of Linear Algebra|Linear Algebra]], we would say that these two [[Notes/Linear Algebra/Module 1/Vectors|vectors]] are [[Orthogonality|Orthogonal]] to each other.

And, since any other vector in the plane can be expressed as some combination of these two [[Notes/Linear Algebra/Module 1/Vectors|vectors]]:
...
But if that these basis [[Notes/Linear Algebra/Module 1/Vectors|vectors]] also have a length of $1$, they would also form an **orthonormal basis.**

We will also be making use of the **Dot Product** of two [[Notes/Linear Algebra/Module 1/Vectors|vectors]], but this is fairly known. (multiplies two [[Notes/Linear Algebra/Module 1/Vectors|vectors]] resulting in a single scalar value, evaluates the difference in direction between the two [[Notes/Linear Algebra/Module 1/Vectors|vectors]]):
...
What a **Hilbert Space** is then, is the extension of these concepts to an **infinite** number of dimensions. And instead of just ordinary [[Notes/Linear Algebra/Module 1/Vectors|vectors]] as we know them ( arrows in space ), [[Notes/Linear Algebra/Module 1/Vectors|vectors]] in a Hilbert Space also include some *abstract mathematical [[Notes/Linear Algebra/Module 1/Vectors|vectors]]*.

These live in the **Vector Space**, which is a well-defined collection of objects that satisfy certain rules. Namely, you can scale and add [[Notes/Linear Algebra/Module 1/Vectors|vectors]] without leaving the space.

![[Screenshot 2025-06-17 at 4.12.49 PM.png]]

A lot of things can fall under this classification. For example:

- The set of all **row [[Notes/Linear Algebra/Module 1/Vectors|vectors]]** form a vector space.

$$
\underbrace{[u_{1},u_{2},\dots,u_{n}]}_{\text{live in a n-dimensional vector space}}
$$

- So do the **column [[Notes/Linear Algebra/Module 1/Vectors|vectors]]**:
...
*Polynomials* form a [[Notes/Linear Algebra/Module 1/Vectors|vectors]] space, $P(\mathbb{R})$, with basis:
