...
1. **Adjacency matrix and adjacency list** Consider the directed graph shown below.

	a) Show both an adjacency matrix representation and an adjacency list representation of the graph. A node is not adjacent to itself unless there is a self-loop.
...
![[Screenshot 2025-09-09 at 10.02.27 AM.png]]
